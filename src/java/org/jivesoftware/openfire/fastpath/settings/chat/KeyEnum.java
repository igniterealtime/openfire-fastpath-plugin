...
public enum KeyEnum {
    ...
    join_help_message("join_help_message"),
    leave_help_message("leave_help_message"),
    ...
    command_accepted_message("command_accepted_message"),
    command_rejected_message("command_rejected_message"),
